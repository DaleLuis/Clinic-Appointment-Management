...
<html>
	...
	<div class="header">
    <ul>
        <li style="float: left; border-right: none;"> <a href="Home.php" class="logo"> <img src="Images/logo.png" width="70px" height="60px"> <strong> Serenity point clinic </strong> Online Apppointment System </a> </li>
	...
	<div class="sucontainer" style="background-image:url(Images/Pic12.jpg)">
		...
		<input type="radio" name="gender" value="other" style="color:black">Other<br><br>
        ...
        <option value="" style="color:black">Select Clinic</option>
        <?php
		...
		<div class="container">
			<button type="submit" style="position:center" name="submit" value="Submit" style="color:black">Submit</button>
		</div>
<?php
